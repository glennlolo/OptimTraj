function [x, err] = rombergQuadratureGen(fun,tSpan,tolIn)
...
coder.varsize("tol",[5,1],[1,0])
coder.varsize("idc",[1 nMax],[0 1])
coder.varsize("time",[1 nSubSegment+1],[0 1])
